...
class OrderVehicleListState extends Equatable {
  ...
  const OrderVehicleListState(
      ...
      required this.orderVehicleList});
  ...
  OrderVehicleListState copyWith({
    ...
    return OrderVehicleListState(
        ...
        orderVehicleList: orderVehicleList ?? List.from(this.orderVehicleList));
  }

  @override
  List<Object> get props => [isLogged, isLoading, orderVehicleList];
}
